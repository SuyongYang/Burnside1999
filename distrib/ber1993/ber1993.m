'Labor Hoarding Model Deterministic Trend'
'Parameters: Theta,Alpha,Delta,Ay,GammY,Ag,GammG,rhoG,sigG,Aa,RhoA,sigA,5 Data Mom'
...
capt=1369 ;
xi=60 ;
ssf=fzero('ssferr',300)

% SET INITIAL PARAMETER VALUES

bstart=[ 3.5 0.68 0.02 9 0.003 7 0.003 0.95 0.02 0.02 0.95 0.01 0.02 1.0 1.0 1.0 1.0 ]' ;
...
xdata=[ c dk g y n k hc hi hy hn hapl ] ;
